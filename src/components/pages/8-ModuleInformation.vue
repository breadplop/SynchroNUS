      ...
      <v-container>
        ...
        <v-layout row wrap class="mb-3">
          <v-flex xs12 sm5>
            ...
            <v-btn v-if="selected_module" color="info" v-on:click="view_module_reviews(selected_module)">View past module reviews for {{selected_module}}</v-btn>
            <v-btn v-if="selected_module" color="info" v-on:click="view_teaching_reviews(selected_module)">View past teaching reviews for {{selected_module}}</v-btn>
  ...
  export default {
    data () {
      return {
        workload_data: [{name: "DSC3215", data: [["0",this.getRandomInt()],["1",this.getRandomInt()],["2",this.getRandomInt()],["3",this.getRandomInt()],["4",this.getRandomInt()],["5",this.getRandomInt()],["6",this.getRandomInt()],["7",this.getRandomInt()],["8",this.getRandomInt()],["9",this.getRandomInt()],["10",this.getRandomInt()],["11",this.getRandomInt()],["12",this.getRandomInt()],["13",this.getRandomInt()]], stack: "stack 1"},
          {name: "DSC3214", data: [["0",this.getRandomInt()],["1",this.getRandomInt()],["2",this.getRandomInt()],["3",this.getRandomInt()],["4",this.getRandomInt()],["5",this.getRandomInt()],["6",this.getRandomInt()],["7",this.getRandomInt()],["8",this.getRandomInt()],["9",this.getRandomInt()],["10",this.getRandomInt()],["11",this.getRandomInt()],["12",this.getRandomInt()],["13",this.getRandomInt()]], stack: "stack 2"}],
    ...
    methods: {
      ...
      add_module(module_code){
        this.workload_data.push({name: module_code, data: [["0",this.getRandomInt()],["1",this.getRandomInt()],["2",this.getRandomInt()],["3",this.getRandomInt()],["4",this.getRandomInt()],["5",this.getRandomInt()],["6",this.getRandomInt()],["7",this.getRandomInt()],["8",this.getRandomInt()],["9",this.getRandomInt()],["10",this.getRandomInt()],["11",this.getRandomInt()],["12",this.getRandomInt()],["13",this.getRandomInt()]], stack: "stack 2"})
      }
    }
  }
</script>
