...
<!--first row-->        
        ...
        <h3>Summary</h3>
        <div class='tooltip'>Most students felt that the teacher was useful.
            <span class='tooltiptext'>More than 50% of students rated at least 4 for Qn: 'The teacher has enhanced my thinking ability'</span>
        </div>
        <br>
        <div class='tooltip'>However, many also few that the teacher could have provided more feedback.
            <span class='tooltiptext'>More than 50% of the students rated 3 or lower for Qn: 'The teacher provided timely and useful feedback.'</span>
        </div>
        <br><br>
